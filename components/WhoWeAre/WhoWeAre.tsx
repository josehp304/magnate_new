            ...
            <div className="whoweare-container">
                <div className="whoweare-scroll">
                    ...
                    <div className="whoweare-img" id="whoweare-img-1">
                        <img src="/images/who-we-are/team-1.jpg" alt="Team member 1" />
                    </div>
                    <div className="whoweare-img" id="whoweare-img-2">
                        <img src="/images/who-we-are/team-2.jpg" alt="Team member 2" />
                    </div>
                    <div className="whoweare-img" id="whoweare-img-3">
                        <img src="/images/who-we-are/team-3.jpg" alt="Team member 3" />
                    </div>
                    <div className="whoweare-img" id="whoweare-img-4">
                        <img src="/images/who-we-are/team-4.jpg" alt="Team member 4" />
                    </div>
                    <div className="whoweare-img" id="whoweare-img-5">
                        <img src="/images/who-we-are/team-5.jpg" alt="Team member 5" />
                    </div>
                </div>
            </div>
        </section>
